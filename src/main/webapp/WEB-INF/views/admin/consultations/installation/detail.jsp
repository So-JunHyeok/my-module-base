        ...
        <div class="detail-container">
            ...
            <div class="post-detail-header">
                ...
                <div class="post-meta-info">
                    ...
                    <div class="meta-right">
                        ...
                        <form id="pinData" method="post" action="/admin/consultations/pinned" style="display:inline;">
                            <input type="hidden" name="page" value="${searchParam.currentPage}">
                            <input type="hidden" name="type" value="${searchParam.type}">
                            <input type="hidden" name="keyword" value="${searchParam.keyword}">
                            <input type="hidden" name="consultationId" value="${data.consultationId}">
            ...
            <div class="post-actions">
                <div class="actions-left">
                    <form id="go_list" method="get" action="/admin/consultations/${typeCode}" style="display:inline;">
                        <input type="hidden" name="page" value="${searchParam.currentPage}">
                        <input type="hidden" name="type" value="${searchParam.type}">
                        <input type="hidden" name="keyword" value="${searchParam.keyword}">
                        <input type="hidden" name="typeCode" value="${typeCode}">
            ...
            <div class="post-navigation">
                <div class="nav-item prev-post">
                    ...
                    <c:if test="${data.prev.name != null}">
                         <a href="/admin/consultations/${typeCode}/${data.prev.consultationId}?currentPage=${searchParam.currentPage}&type=${searchParam.type}&keyword=${searchParam.keyword}" class="nav-link">📌 ${data.prev.name}님의 상담 요청입니다.</a>
                    </c:if>
                </div>
                <div class="nav-divider"></div>
                <div class="nav-item next-post">
                    <span class="nav-label">다음글</span>
                    <c:if test="${data.next.name != null}">
                        <a href="/admin/consultations/${typeCode}/${data.next.consultationId}?currentPage=${searchParam.currentPage}&type=${searchParam.type}&keyword=${searchParam.keyword}" class="nav-link">📌 ${data.next.name}님의 상담요청입니다.</a>
                    </c:if>
                </div>
            </div>
        </div>
